...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-textstem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7441&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-textstem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-textstem` can be installed with:

```
conda install r-textstem
```

It is possible to list all of the versions of `r-textstem` available on your platform with:
